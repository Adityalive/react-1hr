...
const Card = ({ imageurl, username, role, description }) => {
  ...
  return (
    <div className="w-1/4 bg-white p-8 rounded-3xl border border-slate-100 shadow-sm flex  items-center text-center">
      ...
      <div className="space-y-2">
        ...
        <button className='bg-red-300 text-black :active:scale-95 rounded-2xl text-base p-2 border border-amber-950 b'> Deltee It</button>
      </div>
    </div>
  );
};
